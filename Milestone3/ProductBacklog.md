...
<table>
    ...
    <tbody>
        <tr>
            <td>1</td> <td>Started</td> <td>U</td> <td>-</td> <td>Nick</td>
        ...
        <tr>
            <td>2</td> <td>Started</td> <td>U</td> <td>-</td> <td>Tyler</td>
            <td>Being able to login to the site as a certain type of user</td>
            <td>This will add login and register pages. A user can register as a climber or expedition provider. An employee role will be created on the backend. Create an admin page for employees where they can access the db tables to perform CRUD operations. </td>
            <td></td>
        </tr>
        <tr>
            <td>3</td> <td>Started</td> <td>U</td> <td>-</td> <td>Reggie</td>
        ...
        <tr>
            <td>4</td> <td>Started</td> <td>U</td> <td>-</td> <td>Armani</td>
