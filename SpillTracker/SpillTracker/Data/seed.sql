...
INSERT INTO [Form] (Spill_Reported_By,Spill_Reported_Date,Spill_Reported_Time,Spill_Location,Spill_Ongoing,Spill_Contained,Chemical_Pressurized,Spill_Volume,Spill_Volume_Units,Chemical_Concentration,Spill_Forming_Puddle,Spill_Reach_Water_Source,Water_Source,Spill_Duration_Hours,Spill_Duration_Minutes,Cleanup_StartTime,Chemical_Temperature,Chemical_Temperature_Units,Spill_Width,Spill_Width_Units,Spill_Length,Spill_Length_Units,Spill_Depth,Spill_Depth_Units,Spill_Area,Spill_Area_Units,Spill_Reportable,Wind_Direction,Wind_Speed,Wind_Speed_Units,Address_Street,Address_City,Address_State,Address_ZIP,Weather_Temperature,Weather_Temperature_Units,Weather_Humidity,Weather_Humidity_Units,Sky_Conditions,Spill_Evaporation_Rate,Spill_Evaporation_Rate_Units,Amount_Evaporated,Amount_Evaporated_Units,Amount_Spilled,Amount_Spilled_Units,Notes,ContactNotes,STUserID,ChemicalID,Spill_SurfaceID,ChemicalStateID,FacilityID) VALUES
    ('Joe Smith','2020-12-02','14:07:00','LOCATION',0,1,0,2,'gal',0.36,1,0,NULL,01,35,'2020-12-02 14:20:00',77,'F',3,'ft',4,'ft',NULL,NULL,12,'ft\u2072',0,'NE',6,'MPH','ADDRESS','CITY','STATE','ZIP',77,'F',45,'%','Cloudy',0.0017,'lbs/min',0.0035,'lbs',0.00,'lbs','','',1,1,4,2,1); -- no liquid escaped site, rlease to air is 0.0035 lbs, not reportable
