...
namespace SpillTracker.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(SpillTrackerDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,NumFacilities,AccessCode")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
