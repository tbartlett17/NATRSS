...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Calculator can divide two numbers")]
        [NUnit.Framework.TestCaseAttribute("10", "5", "2", null)]
        [NUnit.Framework.TestCaseAttribute("100", "5", "20", null)]
        [NUnit.Framework.TestCaseAttribute("15", "3", "5", null)]
        [NUnit.Framework.TestCaseAttribute("25", "5", "5", null)]
        [NUnit.Framework.TestCaseAttribute("40", "2", "20", null)]
        public virtual void CalculatorCanDivideTwoNumbers(string leftOp, string rightOp, string answer, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Calculator can divide two numbers", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 15
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
